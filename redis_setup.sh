...
if [ -z "$(docker images -q redislabs/redisgraph:1.2.2)" ]
then
    echo "Docker already have a redislabs/redisgraph:1.2.2 image"

else 
    sudo docker run -p 6379:6379 -it --rm redislabs/redisgraph:1.2.2
fi
